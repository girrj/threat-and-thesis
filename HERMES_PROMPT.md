...
6. 오늘 날짜의 content/daily/YYYY-MM-DD.json을 갱신한다. 오늘도 확인할 가치가 있는 항목을 포함해 최대 10건을 순위로 정하고, 직전 날짜와 비교한 previousRank와 status(new/up/down/same/returning), 근거가 분명한 한 문장의 reason을 작성한다. 지난 날짜 스냅샷은 사실 오류 정정 외에는 수정하지 않는다.
